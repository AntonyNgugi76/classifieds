package com.kenova.agribiz.ui.notification.list;
...
import com.kenova.agribiz.databinding.FragmentNotificationListBinding;
import com.kenova.agribiz.ui.common.DataBoundListAdapter;
import com.kenova.agribiz.ui.common.PSFragment;
import com.kenova.agribiz.ui.notification.list.adapter.NotificationListAdapter;
...
public class NotificationListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void replaceData(List<com.kenova.agribiz.viewobject.Noti> notificationList) {
